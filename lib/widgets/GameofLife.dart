...
class gameofLife extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String Text2 = "This project was created by a team of students as part of a mandatory software project. We created a game, where players will have to program an algorithm that will oppose other algorithms. These Algorithms control Agents which move an interact with the map. Whoever has the most Agents or the most energy after a set amount of played rounds, wins the game. We also created a Map Creator to let everyone create maps.\nA big part of my work was in the front-end, as we created one Version in JavaFX and one in Flutter. I also thought of a lot of the balancing and mechanics.";
